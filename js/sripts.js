...
const themeKey = 'halloyunus-theme';
...
// 2. Cek Preferensi saat Halaman Dimuat (Persistence)
document.addEventListener('DOMContentLoaded', () => {
    // Cek apakah ada preferensi yang tersimpan di browser
    ...
    if (savedTheme) {
        ...
        // Jika tidak ada, cek preferensi sistem operasi (default)
        applyTheme('dark');
    } else {
        // Default ke light
        applyTheme('light'); 
